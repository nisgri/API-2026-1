package br.com.serratec.exerciciosaula3.controller;
...
import br.com.serratec.exerciciosaula3.entity.Fornecedor;
import br.com.serratec.exerciciosaula3.repository.FornecedorRepository;
...
public class FornecedorController {
    ...
    @PostMapping("/listas")
    @ResponseStatus(HttpStatus.CREATED)
    public List<Fornecedor> inserir(@RequestBody List<Fornecedor> fornecedores) {
        return repository.saveAll(fornecedores);
    }

    @PutMapping("{id}")
    public ResponseEntity<Fornecedor> atualizar(@RequestBody Fornecedor fornecedor, @PathVariable Long id) {
